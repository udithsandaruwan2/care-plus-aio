...
urlpatterns = [
    ...
    path("match/history/", MatchHistoryListView.as_view(), name="match_history"),
    path(
        "match/history/<int:pk>/",
        MatchHistoryDeleteView.as_view(),
        name="match_history_delete",
    ),
