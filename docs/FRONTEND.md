...
| **3D on web**                       | `react-three-fiber` + Three.js (additive glow; no Bloom pass).                                                | Declarative Three.js in React. Drei/postprocessing were unused and dropped in Step 80.                                                                                                                                                                   |
...
**Stack:** Vite · React 18 · TypeScript · Tailwind · react-three-fiber · Zustand · `reconnecting-websocket` · Zod (shared schemas).
